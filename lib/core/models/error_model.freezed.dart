...
abstract class $ErrorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey() String message, @JsonKey() int code});
}
...
class _$ErrorModelImpl implements _ErrorModel {
  _$ErrorModelImpl(
      {@JsonKey() required this.message, @JsonKey() required this.code});
...
abstract class _ErrorModel implements ErrorModel {
  factory _ErrorModel(
      {@JsonKey() required final String message,
      @JsonKey() required final int code}) = _$ErrorModelImpl;
