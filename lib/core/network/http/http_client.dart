...
import 'package:test_accurate/config/flavors.dart';
import 'package:test_accurate/core/extentions/num_extentions.dart';
...
class HttpClient extends DioMixin {
  ...
  static HttpClient init([HttpSetting? setting]) {
    return HttpClient._(setting ?? HttpSetting(baseUrl: F.baseUrl));
  }
